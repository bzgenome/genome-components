...
export class BzgOverlay {
    ...
    private getPositionProperty(positionStr: string): any {
        ...
        position.horizontal = BzgOverlay[horizontal.toUpperCase()];
        position.vertical = BzgOverlay[vertical.toUpperCase()];
    ...
    private positionItInside(position) {
        ...
        switch (position.horizontal) {
            case BzgOverlay.LEFT:
                this.element.style.justifyContent = 'flex-start';
                break;
            case BzgOverlay.CENTER:
                this.element.style.justifyContent = 'center';
                break;
            case BzgOverlay.RIGHT:
